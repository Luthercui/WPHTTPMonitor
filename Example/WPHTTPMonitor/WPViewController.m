...
//  WPHTTPMonitor
//
//  Created by luther.cui@gmail.com on 03/10/2017.
//  Copyright (c) 2017 luther.cui@gmail.com. All rights reserved.
//

#import "WPViewController.h"
#import <WPHTTPMonitor/WPHTTPViewController.h>
...
- (void)setupView{
    ...
    [btGoMonitorViewController setTitle:@"去网络监控页" forState:UIControlStateNormal];
    ...
    [btRightRequest setTitle:@"点击一个正确请求" forState:UIControlStateNormal];
    ...
    [btErrorRequest setTitle:@"点击一个错误请求" forState:UIControlStateNormal];
    ...
    [btSessionRequest setTitle:@"点击Session请求" forState:UIControlStateNormal];
